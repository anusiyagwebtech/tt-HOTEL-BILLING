...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=hotelbilling;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/ttbilling/hotelbilling/';
    $fsitename = 'http://localhost/ttbilling/hotelbilling/';
    $actual_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOT', $fsitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . "/hotelbilling/";
    ...
    $db = new PDO('mysql:host=localhost;dbname=hotelbilling;charset=utf8mb4', 'hotelbilling', 'hotelbilling');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "hotelbilling", "hotelbilling", "hotelbilling");
    $sitename = "https://ttbilling.in/hotelbilling/";
    $site = 'https://ttbilling.in/hotelbilling/';
    $fsitename = 'https://ttbilling.in/hotelbilling/';
