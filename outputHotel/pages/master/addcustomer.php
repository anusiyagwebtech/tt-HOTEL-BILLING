...
$msg = addcustomer1($cusid,$name,$mobileno,$area,$city,$address,$status,$getid);
}
                ...
                <div class="box-body">
                    ...
                    <div class="row">
						...
						<div class="col-md-4">
                            ...
                            <input type="text"  required="required" name="area" id="area" placeholder="Enter Area" class="form-control" value="<?php echo stripslashes(getcustomer('object',$_REQUEST['cid'])); ?>" />
                        </div>
                        <!-- <div class="col-md-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text"  required="required" name="city" id="mobileno" placeholder="Enter City" class="form-control" value="<?php echo stripslashes(getcustomer('idproof',$_REQUEST['cid'])); ?>" />
                        </div>
                        <div class="col-md-4">
