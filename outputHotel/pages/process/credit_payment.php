...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>List of Credit Payments</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">List of Credit Payments</h3>
            </div><!-- /.box-header -->
            <div class="box-header">
			<?php echo $msg; ?>
             </div><!-- /.box-header -->
...
$message1 = $db->prepare("SELECT * FROM `credit_payment` WHERE `id`!='0'");	
$m=1;
$message1->execute();
...
<td><?php echo $message['balance_amt']; ?></td>
<td>
