...
<html lang="en-IN">
    <head>
        <meta charset="UTF-8">
        <title>Microwebz Hotel Billing | Login</title>
    ...
    <body class="login-page  ">
        <div class="login-box ">
            <div class="login-logo">
                <!--<img src="loginimg.jpg" style="width:160px;"/>-->
                <a href="#"><h3>Microwebz Billing<!-- <img src="<?php echo $sitename; ?>pages/profile/image/1532344513.png" /> --></h3></a>
            </div><!-- /.login-logo -->
